...
The project `aspectRatio` is authoritative. Any ratio written into a style, scene, camera, framing, or composition field must match it exactly; conflicting ratios are invalid output, not creative alternatives.
